...
import { SaveDataSnapshotExecutor } from "./SaveDataSnapshotExecutor";
import { DetectChangesExecutor }    from "./DetectChangesExecutor";
...
export const ExecutorRegistry: RegistryType = {
  ...
  SAVE_DATA_SNAPSHOT: SaveDataSnapshotExecutor,
  DETECT_CHANGES:     DetectChangesExecutor,
